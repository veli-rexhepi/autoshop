...
@section('contentWrapper')
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            <form role="form" method="POST" action="{{ asset('/addACar') }}">                
                @csrf                
                ...
                <div class="box box-info custom-addACar">
                    ...
                    <div class="box-body">
                        <div class="input-group custom-input-group-addCar">
                            ...
                            <input id="Make" name="Make" type="text" class="form-control" maxlength="64" placeholder="Type the vendor name">
                        </div>
                        <br>

                        <div class="input-group custom-input-group-addCar">
                            <span class="input-group-addon custom-addCarLabel">Model</span>
                            <input id="Model" name="Model" type="text" class="form-control" maxlength="64" placeholder="Type the car model">
                        </div>
                        <br>

                        <div class="input-group custom-input-group-addCar">
                            <span class="input-group-addon custom-addCarLabel">Registration</span>
                            <input id="Registration" name="Registration" type="date" class="form-control">
                        </div>
                        <br>

                        <div class="input-group custom-input-group-addCar">
                            <span class="input-group-addon custom-addCarLabel">Engine Size</span>
                            <input id="EngineSize" name="EngineSize" type="text" class="form-control" maxlength="64" placeholder="Type the engine size">
                        </div>
                        <br>
                        ...
                        <div class="box-body">                  
                            <div class="form-group">                              
                                <label>
                                    <input id="Active" name="Active" type="checkbox" class="minimal" value="Active">
                        ...
                        <div class="custom-input-group-addCar-inline">
                            ...
                            <div class="input-group custom-input-group-addCar2">
                                ...
                                <input id="Color" name="Color" type="color" class="form-control custom-carColor" value="#ffffff">                            
                            </div>
                        ...
                        <div class="box-footer custom-input-group-addCar3">
                            <button type="submit" class="btn btn-primary custom-input-submit">Submit</button>
                            <button type="reset" class="btn btn-primary custom-input-reset"
                                onclick="
                                    document.getElementById('Active').checked = false;
                                    apply_iCheckToCheckboxRadio()
                                ">Reset</button>
                            <button type="button" class="btn btn-primary custom-input-reset"
                                onclick="window.location='{{ url("\listCars") }}'">List Cars</button>
                        </div>
                    </div>           
                </div>
            </form>            
